...
double ABCTimeSeriesVectorField::getDeltaXComponentValue(double t, double x, double y, double z)
{
	return sin(z + (this->epsilon * sin(t * this->omega))) + cos(y + (this->epsilon * sin(t * this->omega)));
}

double ABCTimeSeriesVectorField::getDeltaYComponentValue(double t, double x, double y, double z)
{
	return sin(x + (this->epsilon * sin(t * this->omega))) + cos(z + (this->epsilon * sin(t * this->omega)));
}

double ABCTimeSeriesVectorField::getDeltaZComponentValue(double t, double x, double y, double z)
{
